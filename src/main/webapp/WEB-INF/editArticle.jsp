...
<title>Edit <c:out value="${article.title}"/></title>
</head>
<body>
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			<form:form action="/articles/edit/${article.id}" class="contact100-form validate-form" modelAttribute="article">
				...
				<div class="wrap-input100 validate-input" data-validate="Please enter your name">
					<input class="input100" type="text" name="title" placeholder="Title" value="${article.title}">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Please enter your email: e@a.x">
					<input class="input100" type="text" name="category" placeholder="Category" value="${article.category}">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Please enter your phone">
					<input class="input100" type="text" name="description" placeholder="Description" value="${article.description}">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate = "Please enter your phone">
					<input class="input100" type="text" name="picLink" placeholder="Picture Link" value="${article.picLink}"/>
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Please enter your message">
					<textarea class="input100" name="content" placeholder="Article Content">${article.content}</textarea>
					<span class="focus-input100"></span>
				</div>
				<div class="wrap-input100 validate-input">
					<textarea   name="exampleCode" placeholder="Example Code (Optional)">${article.exampleCode}</textarea>
					<span class="focus-input100"></span>
				</div>
