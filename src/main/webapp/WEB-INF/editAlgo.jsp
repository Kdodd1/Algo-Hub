...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>
  	<link rel="icon" type="image/png" href="/contactimages/icons/favicon.ico"/>
<!--===============================================================================================-->
...
<body>
	...
	<div class="wrap-contact100">
   		<form:form action="/edit/${algo.id}"  method="post" modelAttribute="algo">
		<input type="hidden" name="_method" value="put">
		<span class="contact100-form-title">
			Update Algorithm
		</span>
		<div class="wrap-input100 validate-input" data-validate="Title cannot be empty">
			<input class="input100" type="text" name="title" placeholder="Title" value="${algo.title}">
		...
		<form:textarea id="editor3" path="algorithm" rows="40" cols="100" value="${algo.algorithm}"/>
        ...
        var editor3 = CodeMirror.fromTextArea
			...
			<div class="container-contact100-form-btn">
				<form action="/myalgos/${algo.id}" method="post">
					<input type="hidden" name="_method" value="delete">
					<input type="submit" value="Delete" class="contact100-form-btn deleteBtn">
				</form>	
			</div>
		</div>
	</div>
